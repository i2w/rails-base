...
docker push i2wdev/rails-base-builder:r${RUBY_VERSION}-on-r${RAILS_VERSION}-${DEPS_VERSION}
...
docker push i2wdev/rails-base-production:r${RUBY_VERSION}-on-r${RAILS_VERSION}-${DEPS_VERSION}
